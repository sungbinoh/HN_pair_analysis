...
// Thu Aug 23 16:51:55 2018 by ROOT version 6.12/06
// from TTree event/event
// found on file: Single_Muon.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   vector<double>  *muon_ip2D;
   vector<double>  *muon_ip3D;
   vector<double>  *muon_dz;
   vector<double>  *muon_normchi;
   vector<double>  *muon_relIso03;
   vector<double>  *muon_relIso04;
   vector<double>  *muon_minirelIsoBeta;
   vector<double>  *muon_minirelIsoRho;
   ...
   vector<double>  *electrons_minirelIsoBeta;
   vector<double>  *electrons_minirelIsoRho;
   ...
   vector<double>  *electrons_ip2D;
   vector<double>  *electrons_ip3D;
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("Single_Muon.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("Single_Muon.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("Single_Muon.root:/ntuple");
...
void test::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("muon_minirelIsoBeta", &muon_minirelIsoBeta, &b_muon_minirelIsoBeta);
   fChain->SetBranchAddress("muon_minirelIsoRho", &muon_minirelIsoRho, &b_muon_minirelIsoRho);
   ...
   fChain->SetBranchAddress("electrons_minirelIsoBeta", &electrons_minirelIsoBeta, &b_electrons_minirelIsoBeta);
   fChain->SetBranchAddress("electrons_minirelIsoRho", &electrons_minirelIsoRho, &b_electrons_minirelIsoRho);
   ...
   fChain->SetBranchAddress("electrons_ip2D", &electrons_ip2D, &b_electrons_ip2D);
   fChain->SetBranchAddress("electrons_ip3D", &electrons_ip3D, &b_electrons_ip3D);
