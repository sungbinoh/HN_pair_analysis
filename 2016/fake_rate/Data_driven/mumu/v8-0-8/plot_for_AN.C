...
void plot(){
  ...
  draw_histogram("HLT_Mu50_v_ZPeak_leadpt_Nvtx_reweight_central", 0., 500., 10., 20., "P_{T}(1st #mu) (GeV)", true);
  draw_histogram("HLT_Mu27_v_ZPeak_leadpt_Nvtx_reweight_central", 0., 500., 10., 400., "P_{T}(1st #mu) (GeV)", true);
  draw_histogram("HLT_Mu20_v_ZPeak_leadpt_Nvtx_reweight_central", 0., 500., 10., 8000., "P_{T}(1st #mu) (GeV)", true);
  /*
