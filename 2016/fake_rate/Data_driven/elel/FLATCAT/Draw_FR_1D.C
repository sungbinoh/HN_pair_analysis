...
void draw_FR_plot(TString nameofhistogram){
  ...
  pdfname.Append("FR_el_Nvtx_trigger_SF");
  pdfname.Append(".pdf");
...
void draw_prompt_syst(TString map_string, TString Eta_bin){
  ...
  mapTGraphAsymmErrors["FR_" + Eta_bin + "_syst"] -> GetYaxis() -> SetRange(30., 110.);
...
void make_root_file(TString nameofhistogram, double FR_IB[], double FR_OB[], double FR_EC[], double FR_IB_syst_bellow[], double FR_OB_syst_bellow[], double FR_EC_syst_bellow[]){
  ...
  double pt_bins[7] = {47.5, 60., 75., 102.5, 135., 172.5, 237.5};
  ...
  maphist_2D[data_F0 + "FR_syst"] -> GetXaxis() -> SetRangeUser(0., 280.);
  
  maphist_2D[data_F0 + "FR_syst"] -> SetName("FR_ptcone_central");
  
  TFile *MyFile = new TFile("FR_electron_central.root","RECREATE");
...
void draw_all_eta(TString map_string){
  ...
  gStyle -> SetOptStat(0);
  mapTGraphAsymmErrors["FR_IB_syst"] -> GetXaxis() -> SetTitle("P_{T}^{cone} (e)");
  mapTGraphAsymmErrors["FR_IB_syst"] -> GetYaxis() -> SetTitle("Fate Rate");
  mapTGraphAsymmErrors["FR_IB_syst"] -> GetXaxis() -> SetRangeUser(40., 280.);
  mapTGraphAsymmErrors["FR_IB_syst"] -> SetMinimum(0.);
  mapTGraphAsymmErrors["FR_IB_syst"] -> SetMaximum(1.0);
...
void draw_histogram(TString nameofhistogram){
  ...
  double FR_IB[7], FR_OB[7], FR_EC[7];
  double FR_IB_1p15[7], FR_OB_1p15[7], FR_EC_1p15[7]; //increase prompt 15%
  double FR_IB_p85[7], FR_OB_p85[7], FR_EC_p85[7]; // decrease prompt 15%

  double FR_IB_e[7], FR_OB_e[7], FR_EC_e[7];
  double FR_IB_1p15_e[7], FR_OB_1p15_e[7], FR_EC_1p15_e[7];
  double FR_IB_p85_e[7], FR_OB_p85_e[7], FR_EC_p85_e[7];
  
  //float ptarray [] = {40, 55, 65, 85, 120, 150, 195, 280, 350, 500, 1000, 1500, 2000};

  double pt_bins[7] = {47.5, 60., 75., 102.5, 135., 172.5, 237.5};
  //double pt_bins_e[6] = {2.5, 2.5, 2.5, 2.5, 2.5, 2.5}; 
  double pt_bins_e[7] = {7.5, 5., 10., 17.5, 15., 22.5, 42.5};
  ...
  mapTGraphErrors["FR_IB"] = new TGraphErrors(7, pt_bins, FR_IB, pt_bins_e, FR_IB_e);
  mapTGraphErrors["FR_OB"] = new TGraphErrors(7, pt_bins, FR_OB, pt_bins_e, FR_OB_e);
  mapTGraphErrors["FR_EC"] = new TGraphErrors(7, pt_bins, FR_EC, pt_bins_e, FR_EC_e);

  mapTGraphErrors["FR_IB"]  -> Draw();
  
  mapTGraphErrors["FR_IB_p85"] = new TGraphErrors(7, pt_bins, FR_IB_p85, pt_bins_e, FR_IB_p85_e);
  mapTGraphErrors["FR_OB_p85"] = new TGraphErrors(7, pt_bins, FR_OB_p85, pt_bins_e, FR_OB_p85_e);
  mapTGraphErrors["FR_EC_p85"] = new TGraphErrors(7, pt_bins, FR_EC_p85, pt_bins_e, FR_EC_p85_e);

  mapTGraphErrors["FR_IB_1p15"] = new TGraphErrors(7, pt_bins, FR_IB_1p15, pt_bins_e, FR_IB_1p15_e);
  mapTGraphErrors["FR_OB_1p15"] = new TGraphErrors(7, pt_bins, FR_OB_1p15, pt_bins_e, FR_OB_1p15_e);
  mapTGraphErrors["FR_EC_1p15"] = new TGraphErrors(7, pt_bins, FR_EC_1p15, pt_bins_e, FR_EC_1p15_e);

  double FR_IB_syst_upper[7];
  double FR_IB_syst_bellow[7];
  double FR_OB_syst_upper[7];
  double FR_OB_syst_bellow[7];
  double FR_EC_syst_upper[7];
  double FR_EC_syst_bellow[7];
  ...
  mapTGraphAsymmErrors["FR_IB_syst"] = new TGraphAsymmErrors(7, pt_bins, FR_IB, pt_bins_e, pt_bins_e, FR_IB_syst_bellow, FR_IB_syst_upper);
  mapTGraphAsymmErrors["FR_OB_syst"] = new TGraphAsymmErrors(7, pt_bins, FR_OB, pt_bins_e, pt_bins_e, FR_OB_syst_bellow, FR_OB_syst_upper);
  mapTGraphAsymmErrors["FR_EC_syst"] = new TGraphAsymmErrors(7, pt_bins, FR_EC, pt_bins_e, pt_bins_e, FR_EC_syst_bellow, FR_EC_syst_upper);
