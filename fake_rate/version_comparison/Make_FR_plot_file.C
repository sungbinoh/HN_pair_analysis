...
void plot(){
  ...
  */
  ...
  vector<TString> plot_names = gethistnames(Cycle_name, DY_high);
  for(int i = 0; i < plot_names.size(); i++){
    cout << plot_names.at(i) << endl;
  }
  ...
  */
  ...
  for(int i = 0; i < plots_names_F.size(); i++){
    ...
    if(i != 80) maphist_2D[plots_names_F.at(i) + "data_fr"] -> SetName(plots_names_F.at(i) + "_data");
    if(i != 80) maphist_2D[plots_names_F0.at(i) + "data_fr"] -> SetName(plots_names_F0.at(i) + "_data");;
    if(i != 80) maphist_2D[plots_names_F.at(i) + "MC_sum"] -> SetName(plots_names_F.at(i) + "_MC");;
    if(i != 80) maphist_2D[plots_names_F0.at(i) + "MC_sum"] -> SetName(plots_names_F0.at(i) + "_MC");;
      
    if(i != 80) maphist_2D[plots_names_F.at(i) + "data_fr"] -> Write();
    if(i != 80) maphist_2D[plots_names_F0.at(i) + "data_fr"] -> Write();
    if(i != 80) maphist_2D[plots_names_F.at(i) + "MC_sum"] -> Write();
    if(i != 80) maphist_2D[plots_names_F0.at(i) + "MC_sum"] -> Write();
  }
