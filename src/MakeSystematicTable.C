...
void open_files(TString histname){
  ...
  if(signal_file.is_open()){
	...
	for(int j = 0; j < N_syst_comparison; j++){
	  ...
	  TString str_current_hist_Up = histname + "_" + bkgs[i] + "_" + systematics_comparison[j] + TString::Itoa(tag_year,10) + "Up";
	  TString str_current_hist_Down =histname + "_" + bkgs[i] + "_" + systematics_comparison[j] + TString::Itoa(tag_year,10) + "Down";
	  if(systematics_comparison[j].Contains("Jets") || systematics_comparison[j].Contains("SD") ){
	...
	TString str_current_hist_Up = histname + "_" + this_line + "_" + systematics_comparison[j] + TString::Itoa(tag_year,10) + "Up";
	TString str_current_hist_Down = histname + "_" + this_line + "_" + systematics_comparison[j] + TString::Itoa(tag_year,10) + "Down";
	if(systematics_comparison[j].Contains("Jets") || systematics_comparison[j].Contains("SD") ){
	  str_current_hist_Up =histname + "_" + this_line + "_" + systematics_comparison[j] + "Up";
	  str_current_hist_Down =histname + "_" + this_line + "_" + systematics_comparison[j] + "Down";
	}
