...
eval $cp_2016_DATA
#END
#cp_2017_SR_ZpNN_study="cp "${path_SR_ZpNN}'2017/SR_ZpNN_HNPairToJJJJ_*.root '$FILE_PATH'/2017/Signal_Study/'
#cp_2016_SR_ZpNN_study="cp "${path_SR_ZpNN}'2016/SR_ZpNN_HNPairToJJJJ_*.root '$FILE_PATH'/2016/Signal_Study/'
#eval $cp_2017_SR_ZpNN_study
#eval $cp_2016_SR_ZpNN_study
